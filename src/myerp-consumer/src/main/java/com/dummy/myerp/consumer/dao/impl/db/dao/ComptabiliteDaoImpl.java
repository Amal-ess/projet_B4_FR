...
import com.dummy.myerp.consumer.db.DbConsumer;
 ...
 */
public class ComptabiliteDaoImpl implements ComptabiliteDao {

	private final JournalComptableDaoCache journalComptableDaoCache;
	private final CompteComptableDaoCache compteComptableDaoCache;
	private final DbConsumer db;

	public ComptabiliteDaoImpl(DbConsumer db) {
		this.db = db;
		this.journalComptableDaoCache = new JournalComptableDaoCache(this);
		this.compteComptableDaoCache = new CompteComptableDaoCache(this);
	}
	// ==================== Méthodes ====================
	/**
	...
	public List<CompteComptable> getListCompteComptable() {
		JdbcTemplate vJdbcTemplate = new JdbcTemplate(db.getDataSource(DataSourcesEnum.MYERP));
	...
	public List<EcritureComptable> getListEcritureComptable() {
		JdbcTemplate vJdbcTemplate = new JdbcTemplate(db.getDataSource(DataSourcesEnum.MYERP));
		EcritureComptableRM rowMapper = new EcritureComptableRM(journalComptableDaoCache, this);
		List<EcritureComptable> vList = vJdbcTemplate.query(SQLgetListEcritureComptable, rowMapper);
		return vList;
	}
	...
	public EcritureComptable getEcritureComptable(Integer pId) throws NotFoundException {
		NamedParameterJdbcTemplate vJdbcTemplate = new NamedParameterJdbcTemplate(db.getDataSource(DataSourcesEnum.MYERP));
		MapSqlParameterSource vSqlParams = new MapSqlParameterSource();
		vSqlParams.addValue("id", pId);
		EcritureComptable vBean;
		try {
			EcritureComptableRM rowMapper = new EcritureComptableRM(journalComptableDaoCache, this);
			vBean = vJdbcTemplate.queryForObject(SQLgetEcritureComptable, vSqlParams, rowMapper);
	...
	public EcritureComptable getEcritureComptableByRef(String pReference) throws NotFoundException {
		...
		try {
			EcritureComptableRM rowMapper = new EcritureComptableRM(journalComptableDaoCache, this);
			vBean = vJdbcTemplate.queryForObject(SQLgetEcritureComptableByRef, vSqlParams, rowMapper);
		} catch (EmptyResultDataAccessException vEx) {
	...
	public void loadListLigneEcriture(EcritureComptable pEcritureComptable) {
		...
		LigneEcritureComptableRM vRM = new LigneEcritureComptableRM(compteComptableDaoCache);
	...
	public void insertEcritureComptable(EcritureComptable pEcritureComptable) {
		...
		Integer vId = db.queryGetSequenceValuePostgreSQL(DataSourcesEnum.MYERP, "myerp.ecriture_comptable_id_seq",
				Integer.class);
